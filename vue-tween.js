(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('tweezer.js')) :
  typeof define === 'function' && define.amd ? define(['tweezer.js'], factory) :
  (global.VueTween = factory(global.Tweezer));
}(this, (function (Tweezer) { 'use strict';
  ...
  return {
    ...
    bind: function bind$1 () {
      ...
      if (!isPlainObject(handler)) {
        var type$1 = Array.isArray(value)
            ? 'array' : typeof value
...
var vueTween = {
  ...
  install: function install (Vue, ref) {
    ...
    var easing = ref.easing; if ( easing === void 0 ) easing = {};
    ...
    for (var key in this.easing) {
      if (!isFn(this$1.easing[key])) {
        warn(
          "[v-" + (this$1.name) + "] Value of easing '" + key + "' " +
          "must be a function instead of " +
          typeof this$1.easing[key]
        )

        this$1.easing[key] = undefined
      }
    }
